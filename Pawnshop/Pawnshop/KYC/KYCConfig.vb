Module KYCConfig
    ...
    Private Sub MigrateClients_Info()
        ...
        If MsgBox("Patch completed.", MsgBoxStyle.OkOnly) Then diag_loading.pbLoading.Value = 0 : diag_loading.lblStatus.Text = "Idle"

        diag_loading.Close() : frmMain.Enabled = True
    End Sub
