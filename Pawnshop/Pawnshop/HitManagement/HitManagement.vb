Module HitManagement
    ...
    Friend Function Generate_HitReport(dt As Date) As String
        ...
        mySql &= vbCrLf & "	ELSE PH.PHONENUMBER END)AS CONTACTNUMBER FROM KYC_PHONE PH	"
        mySql &= vbCrLf & "	WHERE C.ID = PH.CUSTID	"
        mySql &= vbCrLf & "	ORDER BY PH.ISPRIMARY DESC ROWS 1),	"
