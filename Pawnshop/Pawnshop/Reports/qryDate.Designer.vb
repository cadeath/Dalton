...
Partial Class qryDate
    ...
    Private Sub InitializeComponent()
        ...
        Me.cboReports.Items.AddRange(New Object() {"Schedule of Redeem and Renewal", "Schedule of Loan and Renewal", "Loan Register - New Loan and Renewal 2", "Money Transfer", "Money Transfer (BSP)", "Certificate of Insurance", "Dollar Buying", "Branch Borrowings", "Item Pullout", "Auction Monthly Report", "Dollar Buying Daily"})
