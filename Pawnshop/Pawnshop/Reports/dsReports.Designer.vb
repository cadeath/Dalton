...
Partial Public Class dsReports
    ...
    Partial Public Class MoneyTransferDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddMoneyTransferRow(ByVal ServiceType As String, ByVal TransDate As String, ByVal RefNum As String, ByVal PayOut As String, ByVal SendOut As String, ByVal ServiceCharge As String) As MoneyTransferRow
            Dim rowMoneyTransferRow As MoneyTransferRow = CType(Me.NewRow,MoneyTransferRow)
            Dim columnValuesArray() As Object = New Object() {ServiceType, TransDate, RefNum, PayOut, SendOut, ServiceCharge}
