...
#Region "Procedures and Functions"
    Public Sub SaveTicket(Optional ByVal isNew As Boolean = True)
        ...
        If isNew Then
            ...
            With dsNewRow
                ...
                .Item("pwnItmID") = ItemID
                .Item("ClientID") = Pawner.ID
                .Item("ClaimBy") = ClaimID
                .Item("ORDate") = _orDate
                .Item("ORNum") = _orNum
                ...
                .Item("DelayInterest") = _interest
                .Item("AdvanceInterest") = _advanceInterest
    ...
    Public Sub LoadTicketInReader(ByVal reader As IDataReader)
        Try
            With reader
                _pawnid = .Item("PawnID")
                _pawnTicket = .Item("PawnTicket")
