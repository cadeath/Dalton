Public Class frmBorrowing
    ...
    Private Sub btnPost_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPost.Click
        ...
        With saveBorrow
            ...
            AddJournal(.Amount, "Credit", "Revolving Fund", "Ref# " & .LastIDNumber & " To " & branchcode, "BORROW OUT", , , "BORROWINGS", TransID:=.LastIDNumber)
            AddJournal(.Amount, "Debit", "Due to/from Branches", "Ref# " & .LastIDNumber & " To " & branchcode, , , , "BORROWINGS", TransID:=.LastIDNumber)
