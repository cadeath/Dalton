...
Public Class frmPawningItemNew
    ...
    '        Me.Close()
    '    End Sub
    '    Private Sub txtAppr_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    '        DigitOnly(e)
    '        If isEnter(e) Then
    '            txtPrincipal.Focus()
    '        End If
    ...
    '    Private Sub txtPrincipal_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    '        DigitOnly(e)
    '        If isEnter(e) Then
    ...
    '        frmClient.SearchSelect(secured_str, FormName.frmPawningNew)
    '        frmClient.Show()
    '    End Sub
    ...
    '        If lvSpec.Items.Count >= 1 Then
    '            lvSpec.Columns.RemoveAt(2)
    '            lvSpec.Columns.RemoveAt(3)
    '        End If
    ...
    '        Dim secured_str As String = txtCustomer.Text
    '        secured_str = DreadKnight(secured_str)
    '        frmItemList.SearchSelect(secured_str, FormName.frmPawningNew)
    '        frmItemList.Show()
    '    End Sub


    '    Friend Sub LoadItem(ByVal it As Item)
    '        txtClassification.Text = it.Classification

    '        lvSpec.Items.Clear()
    '        LoadActiveItem()
    '    End Sub

    '    Private Sub LoadActiveItem()
    '        Dim mysql As String
    '        Dim ds As DataSet
    '        mysql = "SELECT * FROM TBL_SPECIFICATION WHERE ITEMID =" & frmItemList.lblItemID.Text

    '        ds = LoadSQL(mysql)
    '        lvSpec.Items.Clear()
    '        For Each dr As DataRow In ds.Tables(0).Rows
    '            Dim tmpSpec As New Item
    '            tmpSpec.LoadSpecByRow(dr)
    '            AddItem(tmpSpec)
    '        Next
    '    End Sub

    '    Private Sub AddItem(ByVal it As Item)
    '        Dim lv As ListViewItem = lvSpec.Items.Add(it.SpecName)
    '        lv.SubItems.Add("")
    '        lv.SubItems.Add(it.SpecType)
    '        lv.SubItems.Add(it.Layout)
    '    End Sub
    ...
    '        If Not lvSpec.SelectedItems.Count = 0 Then
    '            With lvSpec.SelectedItems.Item(0)
    ...
    '  Private Sub txtSerial1_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtSerial1.KeyDown
    '        If e.KeyCode = Keys.Enter Then
    '            AddValuetoListVIew()
    '        End If
    '    End Sub

    '    Private Sub AddValuetoListVIew()
    '        With lvSpec.SelectedItems.Item(0)
    '            For Each item In lvSpec.Items
    '                If item.text = lblSerial.Text Then
    '                    item.subitems(1).text = txtSerial1.Text
    '                End If
    '            Next
    '        End With
    '    End Sub
