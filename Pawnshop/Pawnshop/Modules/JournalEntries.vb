Module JournalEntries
    ...
    Friend Sub AddJournal(ByVal Amt As Double, ByVal DebitCredit As String, ByVal AccountName As String)
        ...
        If ds.Tables(0).Rows.Count > 1 Then Console.WriteLine("Multiple Account Code : " & transactionName)
        If ds.Tables(0).Rows.Count = 0 Then
            Console.WriteLine(transactionName & " cannot be found. Must be a REVOLVING FUND")
        ...
        Else
            With ds.Tables(0)
                AccntID = ds.Tables(0).Rows(0).Item("JRL_ID")
