Module User_rule_mod
    ...
    Friend Sub Create_User_Rule_Table()
        ...
        Try
            ...
            TBL_USERRULE &= vbCrLf & "NEW.USERRULE_ID = GEN_ID(TBL_USERRULE_USERRULE_ID_GEN, 1); "
    ...
    Friend Sub Create_User_table()
        ...
        TBL_USERRULE &= vbCrLf & " LASTLOGIN TIMESTAMP,"
        TBL_USERRULE &= vbCrLf & " EXPIRYDATE DATE NOT NULL,SYSTEMINFO DATE NOT NULL,"
